		...
		<div class="container mx-auto text-center">
			...
			<form action="#" method="post" class="mt-8">
				<div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
					<div class="mb-4">
						<label for="name" class="block text-gray-800 font-bold text-sm mb-2"
							>Your Name:</label
						>
						<input
							type="text"
					...
					<div class="mb-4">
						<label
							for="email"
							class="block text-gray-800 font-bold text-sm mb-2"
							>Your Email:</label
						>
						<input
							type="email"
				...
				<button
					type="submit"
					class="bg-purple-800 text-white hover:bg-blue-400 py-2 px-4 rounded-full text-lg"
				>
					Send Message
				</button>
			</form>
