<template>
    ...
    <nav class="bg-purple-800 p-4">
        <div class="container mx-auto flex justify-between items-center">
            ...
            <ul class="flex space-x-4">
                ...
                <li>
                    <a href="/more" class="text-white hover:text-gray-300"
                        >About</a
                    >
                </li>
                <li>
    ...
    >
        <div class="container mx-auto text-center">
            ...
            />
            <h1
                class="text-4xl md:text-6xl lg:text-8xl font-bold leading-tight mb-4"
            >
                Welcome to V1 - SKM
            </h1>
            <p class="text-lg md:text-xl lg:text-2xl mb-8">
                Explore the excitement, and talent of Myanmar's SKM.
            </p>
            <a
                href="/more"
    ...
    <section id="about" class="py-16">
        <div class="container mx-auto text-center">
            <h2 class="text-3xl md:text-4xl lg:text-5xl font-bold mb-6">
                About V1 - Shan Koe Mee
            </h2>
            <p
                class="text-lg md:text-xl lg:text-2xl text-gray-700 leading-relaxed mx-auto max-w-2xl"
            >
                Shan Koe Mee is a traditional Burmese card game that is popular
                throughout the country. It can be played with two to four
                players and involves a combination of strategy, luck, and
                betting.
            </p>
        </div>
    </section>
