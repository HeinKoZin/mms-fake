        ...
        <div class="container mx-auto text-center">
            ...
            <section id="cultural-significance" class="mb-8">
                ...
                <p class="text-lg md:text-xl lg:text-2xl text-gray-700 leading-relaxed mx-auto max-w-2xl">
                    Bagan holds immense cultural significance, serving as a treasure trove of historical and
            ...
            <section id="events-festivals" class="mb-8">
                ...
                <p class="text-lg md:text-xl lg:text-2xl text-gray-700 leading-relaxed mx-auto max-w-2xl">
                    Immerse yourself in the cultural festivities of Bagan. The city hosts various events and festivals
                    throughout the year, celebrating traditions, art, and community. From religious ceremonies to
                    vibrant cultural performances, there's always something exciting happening in Bagan.
                </p>
            </section>
            ...
            <section id="activities" class="mb-8">
                ...
                <p class="text-lg md:text-xl lg:text-2xl text-gray-700 leading-relaxed mx-auto max-w-2xl">
                    Discover the activities that allow you to experience Bagan in a unique way. Whether it's a hot air
                    balloon ride during sunrise, exploring hidden temples, or participating in traditional ceremonies,
                    Bagan offers a plethora of activities for every type of traveler.
                </p>
            </section>
            ...
            <section id="preservation-efforts" class="mb-8">
                ...
                <p class="text-lg md:text-xl lg:text-2xl text-gray-700 leading-relaxed mx-auto max-w-2xl">
                    Learn about the ongoing efforts to preserve and protect the cultural heritage of Bagan. Preservation
            ...
            <section id="plan-your-visit" class="mb-8">
                ...
                <p class="text-lg md:text-xl lg:text-2xl text-gray-700 leading-relaxed mx-auto max-w-2xl">
                    If you're inspired to explore Bagan in person, find practical information on planning your visit.
